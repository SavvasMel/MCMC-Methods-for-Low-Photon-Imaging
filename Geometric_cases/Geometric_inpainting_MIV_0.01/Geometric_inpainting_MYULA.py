...
path = '../geo_inpainting_MIV_0.01_RMYULA'
...
theta = 632              # hyperparameter of the prior
...
savemat(path + "/geo_inpainting_MIV_0.01_RMYULA_results.mat", RMYULA_results)
savemat(path + "/geo_inpainting_MIV_0.01_RMYULA_MC_chain.mat", RMYULA_MC_chain)

...
path = '../geo_inpainting_MIV_0.1_RMYULA'
...
savemat(path + "/geo_inpainting_MIV_0.1_RMYULA_results.mat", RMYULA_results)
savemat(path + "/geo_inpainting_MIV_0.1_RMYULA_MC_chain.mat", RMYULA_MC_chain)

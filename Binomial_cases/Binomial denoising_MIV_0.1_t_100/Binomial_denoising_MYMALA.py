...
path = '../bin_denoising_MIV_0.1_t100_RMYMALA'
...
savemat(path + "/bin_denoising_MIV_0.1_t100_RMYMALA_results.mat", RMYMALA_results)
savemat(path + "/bin_denoising_MIV_0.1_t100_RMYMALA_MC_chain.mat", RMYMALA_MC_chain)
...
if verbose_lr == 1:
    ...
    savemat(path + "/bin_denoising_MIV_0.1_t100_RMYMALA_results_lr.mat", RMYMALA_results_lr)

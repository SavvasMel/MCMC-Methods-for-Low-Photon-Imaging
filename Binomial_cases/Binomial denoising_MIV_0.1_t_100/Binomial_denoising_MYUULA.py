...
path = '../bin_denoising_MIV_0.1_t100_RMYUULA'
...
savemat(path + "/bin_denoising_MIV_0.1_t100_RMYUULA_results.mat", RMYUULA_results)
savemat(path + "/bin_denoising_MIV_0.1_t100_RMYUULA_MC_chain.mat", RMYUULA_MC_chain)

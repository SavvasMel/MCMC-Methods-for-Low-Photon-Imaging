...
path = '../bin_denoising_MIV_1_t10_RSKROCK'
...
savemat(path + "/bin_denoising_MIV_1_t10_RSKROCK_results.mat", RSKROCK_results)
savemat(path + "/bin_denoising_MIV_1_t10_RSKROCK_MC_chain.mat", RSKROCK_MC_chain)

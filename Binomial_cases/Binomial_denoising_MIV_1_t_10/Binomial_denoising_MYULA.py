...
path = '../bin_denoising_MIV_1_t10_RMYULA'
...
savemat(path + "/bin_denoising_MIV_1_t10_RMYULA_results.mat", RMYULA_results)
savemat(path + "/bin_denoising_MIV_1_t10_RMYULA_MC_chain.mat", RMYULA_MC_chain)

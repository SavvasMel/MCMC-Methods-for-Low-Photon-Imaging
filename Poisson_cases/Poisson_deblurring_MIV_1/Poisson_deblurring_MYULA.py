...
path = '../Poisson_deblurring_MIV_1_RMYULA'
...
savemat(path + "/Poisson_deblur_MIV_1_RMYULA_results.mat", RMYULA_results)
savemat(path + "/Poisson_deblur_MIV_1_RMYULA_MC_chain.mat", RMYULA_MC_chain)

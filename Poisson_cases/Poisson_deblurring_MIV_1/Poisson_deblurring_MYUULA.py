...
path = '../Poisson_deblurring_MIV_1_RMYUULA'
...
savemat(path + "/Poisson_deblur_MIV_1_RMYUULA_results.mat", RMYUULA_results)
savemat(path + "/Poisson_deblur_MIV_1_RMYUULA_MC_chain.mat", RMYUULA_MC_chain)
